# Dashboard — build the cappuccino v16 ref faithfully

*(Not to be confused with `reports/dashboard-v16.md`, which is the 7 August build report for a
different artefact — `design-refs/dashboard-v16.html`. The two refs share a version number and
nothing else; this pass's is `dashboard-cappuccino-v16.html`.)*
