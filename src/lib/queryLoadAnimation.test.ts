...
describe("the order the page settles in", () => {
  ...
  it("masthead → action bar → list card → hero → columns, left to right", () => {
    ...
    /* ⚠️ THE PAIRING CARD TAKES THE HERO'S SLOT (§1). The order is the argument — the page settles
       top-left to bottom-right — and the object above the cards is the pairing card now.
