 ...
 *
 * ⚠️ RECORD-ONLY since §4 (log-sheet run): `requirements` retired with the create takeover; the
 * record journey's `responseChips` still
...
describe("§4 · a chip appears only in its completed form", () => {
  ...
  it("the record header filters to earned chips and draws one mark", () => {
    /* create's header retired with the takeover (§4); the record header's grammar survives */
