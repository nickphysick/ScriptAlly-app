...
describe("HelpButton", () => {
  ...
  it("is a 32px ghost square that lifts to parchment on hover (the bar is off-white again)", () => {
...
describe("The token block — the pack's palette, and why it is prefixed", () => {
  const TOKENS: Record<string, string> = {
    ...
    "--shell-page": "#f7eee7",
    "--shell-railw": "52px",
    "--shell-panelw": "214px",  // 216 → 232 (Amendment 1) → 186 (an interim ref) → 214 (final ref)
