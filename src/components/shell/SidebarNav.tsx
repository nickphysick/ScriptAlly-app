...
// Text-only nav (per the Queries Hub mockup — the leading glyphs were dropped).
...
export const SidebarNav: React.FC<SidebarNavProps> = ({ activeTab, onNavigate, context, account }) => (
  <aside
    style={{
      width: 182, // per the Queries Hub mockup (.side)
      flexShrink: 0,
      background: "#faf5ee",
      ...
      // Top padding matches the desk's top padding (22px) so the logo and the Queries Hub header
      // start on the same line.
      padding: "20px 12px 14px",
      minHeight: 0,
    }}
  >
    {/* Logo + wordmark — the real assets, tucked close, centred at the top of the rail */}
    <button
      type="button"
    ...
    >
      <img src="/scriptally-logo-v2.png" alt="" style={{ height: 22, width: "auto", flexShrink: 0 }} />
      <ScriptAllyLogo size="sm" />
    </button>
